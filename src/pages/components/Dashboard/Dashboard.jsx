...
//       try {
//         // Get all instituteSetup documents
//         const instituteSnapshot = await getDocs(collection(db, "instituteSetup"));
//         if (!instituteSnapshot.empty) {
//           const instituteId = instituteSnapshot.docs[0].id; // Assuming single institute for simplicity
//           const centersQuery = query(collection(db, "instituteSetup", instituteId, "Center"));
          
//           // Set up real-time listener for Centers subcollection
...
//             (err) => setError(err.message)
//           );
//           unsubscribers.push(unsubscribeCenters); // Add to cleanup
//         } else {
//           setLoading(false);
