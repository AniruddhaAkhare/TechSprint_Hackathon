            ...
            <table className="w-full table-auto">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-base font-semibold text-gray-700">Company Name</th>
              ...
              <tbody>
                ...
                {(searchResults.length > 0 ? searchResults : companies).length === 0 && (
                  <tr>
                    <td colSpan={(canUpdate || canDelete) ? 7 : 6} className="px-4 py-3 text-center text-gray-500">
                      No companies found
                    </td>
                  </tr>
                )}
...
//             (company) =>
//                 company.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
//                 (company.pointsOfContact && company.pointsOfContact.some(
//                     (contact) =>
//                         contact.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
//                         contact.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
//                         contact.mobile.toLowerCase().includes(searchTerm.toLowerCase())
