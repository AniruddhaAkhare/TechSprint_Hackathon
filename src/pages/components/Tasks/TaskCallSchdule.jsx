...
// // // // // //                                     Action
// // // // // //                                 </th>
// // // // // //                                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracj=king-wider">
// // // // // //                                     Status
// // // // // //                                 </th>
// // // // // //                             </tr>
// // // // // //                         </thead>
...
// // // // // //                 try {
// // // // // //                     const callDateTime = new Date(`${note.callDate}T${note.callScheduledTime}`);
// // // // // //                     if (isNaN(callDateTime.getTime())) return;
...
// // // // // //                     (call.noteIndex ? c.noteIndex === call.noteIndex : c.noteId === call.noteId)
// // // // // //                         ? { ...c, status: newStatus }
// // // // // //                         : c
// // // // // //                 )
// // // // // //             );
...
// // // // // //         if (call.status === "Completed") return "text-gray-500 line-through";
...
// // // // // //     const determineStatus = (call) => {
// // // // // //         if (call.status === "Completed") return "Overdue";
// // // // // //         if (call.status === "In Progress") return "In Progress";
// // // // // //         if (call.status === "Pending") return "Pending";
// // // // // //         if (call.callDateTime < new Date()) return "Overdue";
// // // // // //         return "Pending";
...
// // // // //             setScheduledCalls(prevCalls =>
// // // // //                 prevCalls.map(c =>
// // // // //                     c.source === call.source && c.entityId === call.entityId && c.noteIndex === call.noteIndex
// // // // //                         ? { ...c, status: newStatus, isCompleted: newStatus === "Completed" }
// // // // //                         : c
// // // // //                 )
// // // // //             );
...
// // //         } catch (err) {
// // //             if (retries > 0) {
// // //                 console.warn(`Retrying fetchScheduledCalls, attempts left: ${retries}`);
// // //                 return fetchScheduledCalls(retries - 1);
// // //             }
// // //             setError(`Failed to load scheduled calls: ${err.message}`);
// // //         } finally {
...
// // //                         });
// // //                     } catch (error) {
// // //                         console.warn(`Invalid enquiry note data for ${enquiryId}:`, error);
// // //                     }
// // //                 });
// // //             });
// // //             return calls;
...
// // //                         });
// // //                     } catch (error) {
// // //                         console.warn(`Invalid company note data for ${companyId}:`, error);
// // //                     }
// // //                 });
// // //             });
// // //             return calls;
...
// //     const { user } = useAuth();
// //     const db = getFirestore();
// //     const [debugInfo, setDebugInfo] = useState({ enquiryCalls: 0, companyCalls: 0 });
...
// //             setDebugInfo({ enquiryCalls: enquiryCalls.length, companyCalls: companyCalls.length });
// //             setScheduledCalls(calls);
// //         } catch (err) {
...
// //                 });
// //             });
// //             console.log(`Fetched ${calls.length} enquiry calls`);
// //             return calls;
// //         } catch (error) {
// //             console.error("Error fetching enquiries:", error);
// //             return [];
...
// //                         const callDateTime = new Date(`${note.callDate}T${note.callScheduledTime}`);
// //                         if (isNaN(callDateTime.getTime())) {
// //                             console.warn(`Invalid date/time for company ${companyId}, note ${noteIndex}`);
// //                             return;
// //                         }
...
// //                         });
// //                     } catch (error) {
// //                         console.warn(`Invalid company note data for ${companyId}, note ${noteIndex}:`, error);
// //                     }
// //                 });
// //             });
// //             console.log(`Fetched ${calls.length} company calls`);
// //             return calls;
// //         } catch (error) {
// //             console.error("Error fetching companies:", error);
// //             return [];
...
// //             ) : scheduledCalls.length === 0 ? (
// //                 <div className="p-4 bg-blue-100 border border-blue-400 text-blue-700 rounded-md text-sm">
// //                     No scheduled calls found. (Enquiries: {debugInfo.enquiryCalls}, Companies: {debugInfo.companyCalls})
// //                 </div>
// //             ) : (
// //                 <>
// //                     <div className="bg-white rounded-lg shadow overflow-x-auto">
...
//             setScheduledCalls(prevCalls =>
//                 prevCalls.map(c =>
//                     c.source === call.source && c.entityId === call.entityId && c.noteIndex === c.noteIndex
//                         ? { ...c, status: newStatus, isCompleted: newStatus === "Completed" }
//                         : c
//                 )
//             );
...
const TaskCallSchedule = () => {
    ...
    const fetchCompanies = async () => {
        try {
            ...
            console.log(`Fetched ${calls.length} company calls (array: ${calls.filter(c => !c.noteId).length}, subcollection: ${calls.filter(c => c.noteId).length})`);
            return calls;
        } catch (error) {
            console.error("Error fetching companies:", error);
            return [];
