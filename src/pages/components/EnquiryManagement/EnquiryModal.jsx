...
// // //               className={`px-3 py-1 sm:px-4 sm:py-2 rounded-md text-white text-sm ${isRecording ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"} transition-colors`}
// // //             >
...
// // //                     <div key={index} className="mb-3 sm:mb-4 p-3 sm:p-4 border border-gray-200 rounded-md">
...
// // //                         </div>
// // //                       )}
// // //                       <p className="text-xs sm:text-sm text-gray-900">{note.content}</p>
// // //                     </div>
// // //                   ))
// // //                 ) : (
...
// //       if (audioUrl) {
// //         // Automatically add a note with the audio URL
// //         const noteObject = {
...
//   const uploadToS3 = async (audioBlob) => {
//     console.log('Starting upload...', audioBlob);
//     if (!audioBlob) {
...
//   //       Body: new Uint8Array(fileBuffer),
//   //       ContentType: "audio/webm",
//   //       // ACL: "public-read", // Uncomment if public access is intended
//   //     };
...
//   const handleAddNoteToFirebase = async (updatedNotes, noteObject) => {
//     console.log('Adding note with:', noteObject);
//     if (!editingEnquiryId) {
//       alert("No enquiry selected to add note.");
//       return;
//     }
...
//                   )}
//                 </div>
//                 <div className="mb-3 sm Chief Operating Officer:mb-4">
//                   <label className="block text-xs sm:text-sm font-medium text-gray-700">Date of Birth</label>
//                   {isEditing ? (
//                     <input
//                       type="date"
...
//                           {notes
//                             // Sort notes within each date by time (descending)
//                             .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt))
//                             .map((note, index) => (
//                               <div key={index} className="p-3 sm:p-4 rounded-md">
//                                 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2">
...
//                                   </div>
//                                 )}
//                                 {/* // In the notes rendering section (currentSection === 4) */}
// {note.type === "office-visit" && note.audioUrl && (
//    console.log('Audio URL:', note.audioUrl),
//   <div className="mb-2">
//     <audio controls className="w-full">
//       <source src={note.audioUrl} type="audio/webm" />
//       Your browser does not support the audio element.
