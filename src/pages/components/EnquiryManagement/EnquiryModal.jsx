...
// // // //         const fileName = `visit-recording-${editingEnquiryId || "new"}-${new Date().toISOString()}.webm`;
...
// // // //             setAudioBlob(null);
// // // //         } catch (error) {
// // // //             alert(`Failed to upload recording to S3: ${error.message}`);
// // // //         }
// // // //     };
...
// // // //               className={`px-4 py-2 rounded-md text-white ${isRecording ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"} transition-colors`}
// // // //             >
// // // //               {isRecording ? "Stop Visit" : "Start Visit"}
// // // //             </button>
// // // //           </div>
// // // //         </div>
// // // //         <div className="flex justify-between mb-4 flex-wrap gap-2">
...
// // //               Enquiry Details
// // //             </button>
// // //             <button onClick={() => setCurrentSection(4)} className=`px-4 py-2 border rounded-md ${currentSection === 4 ? "bg-blue-600 text-white" : "border-gray-300 text-gray-700 hover:bg-gray-100"}`}
// // //             >
// // //               Notes
// // //             </button>
// // //             <button
...
// //             <button
// //               onClick={() => setCurrentSection(4)}
// //               className={currentSection === 4 ? "px-4 py-2 border rounded-md bg-blue-600 text-white" : "px-4 py-2 border rounded-md border-gray-300 text-gray-700 hover:bg-gray-100"}
// //             >
// //               Notes
// //             </button>
// //             <button
...
// //                         <div className="text-sm text-gray-600 mb-2">
// //                           <p>Date: {note.callDate || "Not specified"}</p>
// //                           <p>Time imperialism: {note.callScheduledTime || "Not specified"}</p>
// //                         </div>
// //                       )}
// //                       <p className="text-sm text-gray-900">{note.content}</p>
// //                     </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="mb-4">
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 text-sm text-gray-900">{renderField(newEnquiry.closingDate)}</p>
                  )}
                </div>
                <div className="mb-4">
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 text-sm text-gray-900">{renderField(stageDisplay[newEnquiry.stage]?.name)}</p>
                  )}
                </div>
                {newEnquiry.stage === "closed-lost" && (
                  <div className="mb-4">
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-sm text-gray-900">{renderField(newEnquiry.lostReason)}</p>
                    )}
                  </div>
                )}
              </div>
