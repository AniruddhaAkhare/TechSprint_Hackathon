...
// const Column = ({ columnId, column, filteredEnquiries, canUpdate, handleViewEnquiry, handleAddNotes, handleSelectForDeletion, selectedForDeletion }) => {
//   return (
//     <Droppable droppableId={columnId}>
//       {(provided) => (
//         <div className="bg-white rounded-lg shadow-md w-72 flex-shrink-0" {...provided.droppableProps} ref={provided.innerRef}>
...
//                       onContextMenu={(e) => {
//                         e.preventDefault();
//                         if (handleSelectForDeletion) {
//                           handleSelectForDeletion(item.id);
//                         }
//                       }}
//                       style={{ cursor: "pointer", ...provided.draggableProps.style }}
//                     >
...
// //                   {(provided) => (
// //                     <div
// //                     className={`bg-white p-4 mb-2 rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer ${
// //                       selectedForDeletion.includes(item.id) ? "border-2 border-red-500 bg-red-100" : ""
// //                     }`}
// //                       // className={`bg-white border ${selectedForDeletion.includes(item.id) ? "border-red-500 bg-red-100" : "border-gray-200"} rounded-md p-4 mb-2 shadow-sm relative`}
// //                       ref={provided.innerRef}
// //                       {...provided.draggableProps}
// //                       {...provided.dragHandleProps}
// //                       onClick={() => handleViewEnquiry(item)}
