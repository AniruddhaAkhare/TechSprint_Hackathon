...
//                 if (docSnap.exists()) {
//                     setCourseData({ ...docSnap.data(), subjects: docSnap.data().subjects || [], centers: docSnap.data().centers || [] });
//                 } else {
...
//         const updatedSubjects = courseData.subjects.map((subject, i) =>
//             i === index ? { ...subject, subjectName: newValue } : subject
//         );
//         setCourseData(prevState => ({ ...prevState, subjects: updatedSubjects }));
//     };

//     const handleCenterChange = (centerId) => {
//         setCourseData(prevState => {
//             const isSelected = prevState.centers.includes(centerId);
//             return {
//                 ...prevState,
//                 centers: isSelected ? prevState.centers.filter(id => id !== centerId) : [...prevState.centers, centerId]
//             };
//         });
//     };
...
//                         <input
//                             type="checkbox"
//                             checked={courseData.centers.includes(center.id)}
...
//                     <input key={index} type="text" value={subject.subjectName} onChange={(e) => handleSubjectChange(index, e.target.value)} className="w-full border p-2 rounded mb-2" placeholder={`Subject ${index + 1}`} />
//                 ))}
