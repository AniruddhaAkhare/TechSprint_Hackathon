...
// // //     const fetchCourses = async () => {
// // //         const q = query(CourseCollectionRef, orderBy('createdAt', 'asc'));
// // //         const snapshot = await getDocs(q); // Using the query with orderBy
// // //         const courseData = snapshot.docs.map(doc => ({
// // //             id: doc.id,
// // //             ...doc.data(),
// // //         }));
...
// // //                                 <td>{index + 1}</td>
// // //                                 <td>{course.name}</td>
// // //                                 <td>{course.status || "Ongoing"}</td> {/* Display status with fallback */}
// // //                                 <td>
// // //                                     <div className="flex items-center space-x-2">
// // //                                         <button 
// // //                                             onClick={() => { setDeleteId(course.id); setOpenDelete(true); }} 
...
// // //             <Dialog open={openDelete} handler={() => setOpenDelete(false)}>
// // //                 <DialogHeader>Confirm Deletion</DialogHeader>
// // //                 <DialogBody>Are you sure you want to delete this course? This action cannot be undone.</DialogBody>
// // //                 <DialogFooter>
// // //                     <Button variant="text" color="gray" onClick={() => setOpenDelete(false)}>Cancel</Button>
// // //                     <Button variant="filled" color="red" onClick={deleteCourse}>Yes, Delete</Button>
// // //                 </DialogFooter>
...
// //     const CourseCollectionRef = collection(db, "Course");
// //     const StudentCollectionRef = collection(db, "student"); // Assuming students are stored here
// //     const [isOpen, setIsOpen] = useState(false);
// //     const [openDelete, setOpenDelete] = useState(false);
// //     const [deleteId, setDeleteId] = useState(null);
...
// //         if (deleteId) {
// //             try {
// //                 // Check if any student is enrolled in the course
...
// //                                     <div className="flex items-center space-x-2">
// //                                         <button 
// //                                             onClick={() => { setDeleteId(course.id); setOpenDelete(true); setDeleteMessage("Are you sure you want to delete this course? This action cannot be undone."); }} 
// //                                             className="bg-red-500 text-white px-4 py-1 rounded-lg hover:bg-red-600"
// //                                         >
// //                                             Delete
// //                                         </button>
