...
export default function Courses() {
  ...
  const toggleSidebar = () => {
    ...
    if (!isOpen) {
      ...
      setCurrentCourse(null); // Reset currentCourse when closing
    }
  };
  ...
  const handleCreateCourseClick = () => {
    ...
    setCurrentCourse(null); // Explicitly set to null for create
    setIsOpen(true);
  };
  ...
  const handleEditClick = (course) => {
    ...
    setCurrentCourse(course); // Set the specific course to edit
    setIsOpen(true);
  };

  const handleClose = () => {
    setIsOpen(false);
    setCurrentCourse(null); // Reset currentCourse on close
