...
// // const AddMaterialModal = ({ isOpen, onClose, curriculumId, sectionId }) => {
// //   const [view, setView] = useState('typeSelection'); // 'typeSelection', 'pdfConfig', or 'videoConfig'
// //   const [selectedType, setSelectedType] = useState(null);
// //   const [file, setFile] = useState(null);
// //   const [uploading, setUploading] = useState(false);
// //   const [error, setError] = useState(null);
...
// //       setView('videoConfig'); // Transition to Video configuration view
// //     } else {
// //       // Placeholder for other material types
// //       alert(`Proceeding with material type: ${selectedType}`);
// //       onClose();
...
// //   // Handle file selection with validation for Video
// //   const handleFileChange = (e) => {
// //     const selectedFile = e.target.files[0];
// //     if (selectedFile) {
// //       if (view === 'pdfConfig') {
...
// //         // Validate for Video (mp4, mpeg, webm)
...
// //   // Handle file upload to S3 (for both PDF and Video)
...
//       // Simulate upload progress (since PutObjectCommand doesn't provide progress natively)
