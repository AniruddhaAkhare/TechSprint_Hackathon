...
// // //             where("status", "==", "active") // Adjust this if needed
// // //           );
// // //           const centersSnapshot = await getDocs(centersQuery);
// // //           console.log(`Centers for institute Ascendantly found in institute ${instituteDoc.id}:`, centersSnapshot.docs.length);
...
// // //     centerNames.length === 0 || centerNames.includes(student.centerId)
// // //   );

// // //   const filteredBatches = batches.filter(batch => 
// // //     centerNames.length === 0 || centerNames.includes(batch.centerId)
// // //   );
...
// //         : [...prev, centerId]
// //     );
// //     setSelectedBatches([]); // Reset batches when centers change
// //     setSelectedStudents([]); // Reset students when centers change
// //   };
...
//           const centersQuery = query(
//             collection(db, "instituteSetup", instituteDoc.id, "Center"),
//             where("isActive", "==", true) // Updated to match your data
//           );
//           const centersSnapshot = await getDocs(centersQuery);
//           console.log(`Centers for institute ${instituteDoc.id}:`, centersSnapshot.docs.length);
