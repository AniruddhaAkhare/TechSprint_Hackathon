...
// // Configure AWS SDK (replace with your credentials and region)
// AWS.config.update({
//   accessKeyId: 'your-access-key-id', // Replace with your IAM Access Key
//   secretAccessKey: 'your-secret-access-key', // Replace with your IAM Secret Key
...
//   const [file, setFile] = useState(null);
//   const [loading, setLoading] = useState(false);
//   const navigate = useNavigate(); // Fixed typo: useNavigate() not {navigate}
...
//     const params = {
//       Bucket: 'fireblaze-assignments', // Replace with your S3 bucket name
//       Key: `assignments/${file.name}`, // File path in S3
//       Body: file, // The file object from input
...
//       return uploadResult.Location; // Returns the S3 URL
//     } catch (error) {
...
//   const handleSubmit = async () => {
//     if (!selectedCurriculum || !dueDate || !file) {
...
//         curriculum: selectedCurriculum,
//         dueDate,
//         fileUrl, // Store the S3 URL in Firestore
//         timestamp: new Date(),
//       });
