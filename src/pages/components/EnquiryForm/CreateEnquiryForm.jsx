                                ...
                                <div className="flex items-center">
                                  ...
                                  <label className="ml-2 flex items-center">
                                    <input
                                      ...
                                      disabled={loading || isDragging}
                                    />
                                    <span className="ml-1 text-sm text-gray-600">Read-Only</span>
                                  </label>
                                </div>
                                    ...
                                    <>
                                      ...
                                      {field.useDynamicOptions ? (
                                        <select
                                          value={field.defaultValue || ""}
                                          onChange={(e) => handleDefaultValueChange(field.id, e.target.value)}
                                          className="p-1 border border-gray-300 rounded-md text-sm w-1/3"
                                          disabled={loading || isDragging}
                                        >
                                          <option value="">Select default</option>
                                          {fieldOptions.length > 0 ? (
                                        ...
                                        <>
                                          <input
                                            ...
                                            className="p-1 border border-gray-300 rounded-md text-sm w-1/2"
                                            disabled={loading || isDragging}
                                          />
                                          <select
                                            value={field.defaultValue || ""}
