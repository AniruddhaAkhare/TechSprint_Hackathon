            ...
            <form className="student-form" onSubmit={handleAddStudent}>
                ...
                <div className="form-group">
                    ...
                    <div className="flex">
                        <div className="w-2/4">
                            <label>Name</label>
                            <input type="text" placeholder="Guardian Name" value={guardianDetails.name} onChange={(e) => handleGuardianChange('name', e.target.value)} />
                        </div>
                        <div className="w-2/4">
                            <label>Phone</label>
                            <input type="text" placeholder="Guardian Phone" value={guardianDetails.phone} onChange={(e) => handleGuardianChange('phone', e.target.value)} />
                        </div>
                    </div>
                    <div className="flex">
                        <div className="w-2/4">
                            <label>Email</label>
                            <input type="email" placeholder="Guardian Email" value={guardianDetails.email} onChange={(e) => handleGuardianChange('email', e.target.value)} />
                        </div>
                        <div className="w-2/4">
                            <label>Relation</label>
                            <input type="text" placeholder="Relation" value={guardianDetails.relation} onChange={(e) => handleGuardianChange('relation', e.target.value)} />
                        </div>
                    </div>
                    <div className="flex">
                        <div className="w-2/4">
                            <label>Occupation</label>
                            <input type="text" placeholder="Occupation" value={guardianDetails.occupation} onChange={(e) => handleGuardianChange('occupation', e.target.value)} />
                        </div>
                    </div>
                </div><br /><br />
                ...
                <div className="form-group">
                    <div className="flex">
                        <div className="w-2/4">
                            ...
                            <label>Country</label>
                            <input type="text" placeholder="Country" value={address.country} onChange={(e) => setAddress({ ...address, country: e.target.value })} />
                            {/* <label><Checkbox checked={copyAddress} onChange={(e) => handleCopyAddress(e.target.checked)} /> Same as Residential Address</label> */}
                        </div>
                            <label> <input type="checkbox" checked={copyAddress} onChange={(e) => handleCopyAddress(e.target.checked)} /> Same as Residential Address </label>
                        <div className="w-2/4">
                            <h3 className="text-lg font-semibold mb-4">Billing Address</h3>
                ...
                {/* Experience Details with Salary and Years */}
                <div className="overflow-x-auto">
                    <h3 className="text-lg font-semibold mb-4">Experience Details</h3>
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                        <thead className="bg-blue">
                            <tr>
                                ...
                                <th className="py-2 px-4 border border-gray-300">Designation</th>
                                <th className="py-2 px-4 border border-gray-300">Salary</th>
                                <th className="py-2 px-4 border border-gray-300">Experience (Years)</th>
                                <th className="py-2 px-4 border border-gray-300">Description</th>
                                <th className="py-2 px-4 border border-gray-300">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {experienceDetails.map((experience, index) => (
                                <tr key={index} className="hover:bg-gray-100">
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="text" placeholder="Company Name" value={experience.companyName} onChange={(e) => handleExperienceChange(index, 'companyName', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="text" placeholder="Designation" value={experience.designation} onChange={(e) => handleExperienceChange(index, 'designation', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="number" placeholder="Salary" value={experience.salary} onChange={(e) => handleExperienceChange(index, 'salary', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="number" placeholder="Years" value={experience.years} onChange={(e) => handleExperienceChange(index, 'years', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="text" placeholder="Description" value={experience.description} onChange={(e) => handleExperienceChange(index, 'description', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <button type="button" onClick={() => deleteExperience(index)} className="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600 transition duration-200">
                                            <FontAwesomeIcon icon={faXmark} />
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <button type="button" onClick={addExperience} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Add Experience</button>
                </div><br /><br />

                {/* Course Details with Editable Fees
                <div className="overflow-x-auto">
                    ...
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                        <thead className="bg-blue">
                            <tr>
                                ...
                                <th className="py-2 px-4 border border-gray-300">Center</th>
                                <th className="py-2 px-4 border border-gray-300">Mode</th>
                                <th className="py-2 px-4 border border-gray-300">Course Fee</th>
                                <th className="py-2 px-4 border border-gray-300">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {courseDetails.map((course, index) => (
                                <tr key={index} className="hover:bg-gray-100">
                                    <td className="py-2 px-4 border border-gray-300">
                                        <select value={course.courseName} onChange={(e) => handleCourseChange(index, 'courseName', e.target.value)} className="border-gray-300 rounded w-full">
                                            <option value="">Select Course</option>
                                            {courses.map(c => (
                                                <option key={c.id} value={c.name}>{c.name}</option>
                                            ))}
                                    ...
                                    <td className="py-2 px-4 border border-gray-300">
                                        <select value={course.batch} onChange={(e) => handleCourseChange(index, 'batch', e.target.value)} className="border-gray-300 rounded w-full">
                                            <option value="">Select Batch</option>
                                            {batches.map(b => (
                                                <option key={b.id} value={b.name}>{b.name}</option>
                                            ))}
                                    ...
                                    <td className="py-2 px-4 border border-gray-300">
                                        <select value={course.center} onChange={(e) => handleCourseChange(index, 'center', e.target.value)} className="border-gray-300 rounded w-full">
                                            <option value="">Select Center</option>
                                            {centers.map(center => (
                                                <option key={center.id} value={center.name}>{center.name}</option>
                                            ))}
                                    ...
                                    <td className="py-2 px-4 border border-gray-300">
                                        <select value={course.mode} onChange={(e) => handleCourseChange(index, 'mode', e.target.value)} className="border-gray-300 rounded w-full">
                                            <option value="">Select Mode</option>
                                            <option value="Online">Online</option>
                                            <option value="Offline">Offline</option>
                                        </select>
                                    ...
                                    <td className="py-2 px-4 border border-gray-300">
                                        <input type="number" value={course.fee} onChange={(e) => handleCourseChange(index, 'fee', e.target.value)} className="border-gray-300 rounded w-full" />
                                    </td>
                                    <td className="py-2 px-4 border border-gray-300">
                                        <button type="button" onClick={() => deleteCourse(index)} className="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600 transition duration-200">
                                            <FontAwesomeIcon icon={faXmark} />
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <button type="button" onClick={addCourse} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Add Course</button>
                </div><br /><br /> */}
                ...
                <div className="w-2/4">
                            <label><b>Date Of Enrollment</b></label><br />
                ...
                <div>
                    ...
                    <div className="overflow-x-auto">
                        <label><b>Add Discount</b></label><br />
                        <input type="number" value={discount} placeholder="Discount" onChange={(e) => setDiscount(e.target.value)} className="border-gray-300 rounded w-1/4" /> %<br />
                        <button type="button" onClick={handleFeeSummary} className="mt-2 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Apply Discount</button><br />
                        <div className="w-2/4">
                            <label><b>Fees Summary</b></label><br />
                            Total: <input type="number" value={total} disabled className="w-1/4 border-gray-300 rounded" /><br />
                        </div>
                        ...
                        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                            ...
                            <tbody>
                                {installmentDetails.map((installment, index) => (
                                    <tr key={index} className="hover:bg-gray-100">
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="text" value={installment.number} readOnly className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="number" value={installment.dueAmount} onChange={(e) => handleInstallmentChange(index, 'dueAmount', e.target.value)} className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="date" value={installment.dueDate} onChange={(e) => handleInstallmentChange(index, 'dueDate', e.target.value)} className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="date" value={installment.paidDate} onChange={(e) => handleInstallmentChange(index, 'paidDate', e.target.value)} className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="number" value={installment.paidAmount} onChange={(e) => handleInstallmentChange(index, 'paidAmount', e.target.value)} className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <select value={installment.modeOfPayment} onChange={(e) => handleInstallmentChange(index, 'modeOfPayment', e.target.value)} className="w-full border-gray-300 rounded">
                                                <option value="" disabled>Select</option>
                                        ...
                                        <td className="py-2 px-4 border border-gray-300">
                                            <select value={installment.pdcStatus} onChange={(e) => handleInstallmentChange(index, 'pdcStatus', e.target.value)} className="w-full border-gray-300 rounded">
                                                <option value="" disabled>Select</option>
                                        ...
                                        <td className="py-2 px-4 border border-gray-300">
                                            <input type="text" value={installment.remark} onChange={(e) => handleInstallmentChange(index, 'remark', e.target.value)} className="w-full border-gray-300 rounded" />
                                        </td>
                                        <td className="py-2 px-4 border border-gray-300">
                                            <button type="button" onClick={() => deleteInstallment(index)} className="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600 transition duration-200">
                                                <FontAwesomeIcon icon={faXmark} />
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <button type="button" onClick={addInstallment} className="mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Add Installment</button>
                    </div>
                </div><br /> */}
