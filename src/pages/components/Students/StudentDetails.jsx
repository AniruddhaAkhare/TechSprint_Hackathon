...
export default function StudentDetails() {
    ...
    //             const existingCourseIds = student.course_details?.map(c => c.courseId) || [];
                
    //             // Filter out already enrolled courses
    //             const newCourseIds = selectedCourse.filter(courseId => 
    ...
    //             // Prepare course details for batch update
    ...
    //             // Update student document with new course details
    //             batch.update(studentRef, {
    //                 course_details: arrayUnion(...newCourseDetails)
    //             });

    //             // Create enrollment records for each new course
