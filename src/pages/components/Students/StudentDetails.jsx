...
//   // Fetch data only once on mount or when permissions/navigate change
//   useEffect(() => {
//     if (!canDisplay) {
...
//       try {
//         const [studentCount, courseCount, centerCount, batchCount] =
//           await Promise.all([
//             fetchStudents(),
//             fetchCourse(),
//             fetchCenters(),
...
//         // Initialize available centers and batches after fetching
//         setAvailableCenters(centers);
//         setAvailableBatches(batches);

//         console.log(
//           `Fetched data: ${studentCount} students, ${courseCount} courses, ${centerCount} centers, ${batchCount} batches`
//         );
//       } catch (error) {
...
//     fetchData();
//   }, [canDisplay, navigate]); // Dependencies limited to avoid re-runs

//   // Apply filters when students, filters, or searchQuery change
//   useEffect(() => {
...
//   // Update available centers and batches when centers or batches change
//   useEffect(() => {
//     setAvailableCenters(centers);
//   }, [centers]);
...
//         id: doc.id,
//         ...doc.data(),
//         centerIds: doc.data().centerIds || [], // Fallback to empty array
//       }));
...
//         console.warn("No instituteSetup documents found");
//         setCenters([]);
...
//         // Removed isActive filter to test if it’s causing the issue
//       );
...
//         console.warn("No centers found for institute:", instituteId);
//         toast.warn("No centers available");
//       }

//       setCenters(centerList);
//       console.log("Fetched centers:", centerList);
...
//         console.warn("No batches found in Batch collection");
//         toast.warn("No batches available");
//       }
...
//         );
//         return studentCenters.includes(currentFilters.center);
//       });
//     }
...
//         validCenterIds.includes(center.id)
//       );
//       setAvailableCenters(filteredCenters);
//       const filteredBatches = batches.filter((batch) => batch.courseId === value);
//       setAvailableBatches(filteredBatches);
//     } else if (name === "center") {
//       newFilters.batch = "";
//       const filteredBatches = batches.filter(
//         (batch) =>
//           batch.courseId === filters.course && batch.centerId === value
//       );
//       setAvailableBatches(filteredBatches);
//     }
