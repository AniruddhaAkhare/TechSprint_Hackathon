...
//   const CHECK_IN_RADIUS = 100; // Radius in meters
...
//         dailyDurations[existingDayIndex] = {
//           date: dateStr,
...
//   const sendCheckOutEmail = async (email, timestamp, duration) => {
//     try {
//       await fetch("https://api.zeptomail.com/v1.1/email", {
//         method: "POST",
//         headers: {
...
//           htmlbody: `<p>You have successfully checked out on ${new Date(timestamp).toLocaleString()}.</p><p>Duration: ${duration} hours</p>`,
//         }),
//       });
//     } catch (error) {
...
const CheckInOut = () => {
  ...
  const [liveDuration, setLiveDuration] = useState(null);
  const CHECK_IN_RADIUS = 100; // Radius in meters
  const AUTO_CHECKOUT_INTERVAL = 300000; // Check every 5 minutes (in ms)
  const GRACE_PERIOD = 2; // Number of consecutive out-of-range checks before auto-checkout
