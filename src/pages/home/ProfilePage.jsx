...
// // // //   const bucketName = 'my-app-profile-photos'; // Replace with your S3 bucket name
// // // //   const bucketRegion = 'us-east-1'; // Replace with your bucket region
// // // //   const IdentityPoolId = 'us-east-1:xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx'; // Replace with your Cognito Identity Pool ID
...
// // // //     const photoKey = `profile-photos/${user.uid}/${fileName}`;
...
// // // //       const photoURL = `https://${bucketName}.s3.${bucketRegion}.amazonaws.com/${photoKey}`;
...
// //         Body: new Uint8Array(fileBuffer),
// //         ContentType: file.type,
// //         // Removed ACL: 'public-read' since bucket does not allow ACLs
// //       };
...
// //       // Update local state to reflect new photo in UI
// //       setUserData((prev) => ({ ...prev, photoURL }));
// //       alert('Photo uploaded successfully!');
// //     } catch (err) {
// //       setUploadError(`Failed to upload photo: ${err.message}`);
...
// //                 className="w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-gray-200"
// //                 onError={(e) => {
// //                   e.target.src = 'https://via.placeholder.com/150'; // Fallback if photoURL fails to load
// //                 }}
// //               />
// //               <span
// //                 className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${
...
//   const auth = getAuth();
//   const user = auth.currentUser;
//   const placeholderImage = 'https://placehold.co/150x150'; // Reliable placeholder
...
//                 className="w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-gray-200"
//                 onError={(e) => {
//                   e.target.src = placeholderImage; // Fallback to reliable placeholder
//                 }}
//               />
//               <span
//                 className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${
