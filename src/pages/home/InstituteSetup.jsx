...
//   // New function to handle editing a branch
...
//       });
//       setCurrentBranch(null);
//       setBranchCountryCode("+91"); // Reset country code
//       const branchesSnapshot = await getDocs(collection(db, "instituteSetup", instituteId, "Center"));
//       const branchList = branchesSnapshot.docs.map((doc) => ({
//         id: doc.id,
//         ...doc.data(),
...
//   return (
//     <div className="institute-setup p-20">
//       {/* ... (other JSX remains unchanged until Branch Setup) */}
//       <div className="header">
//          <FaBook className="header-icon" />
//          <h1>Institute Setup</h1>
//       </div>
...
//                       onChange={(e) => {
//                         setBranchCountryCode(e.target.value);
//                         setBranchForm((prev) => ({
//                           ...prev,
//                           contactNumber: `${e.target.value}${prev.contactNumber.replace(branchCountryCode, "")}`,
//                         }));
//                       }}
...
//                       type="text"
//                       name="contactNumber"
//                       value={branchForm.contactNumber.replace(branchCountryCode, "")}
//                       onChange={handleBranchChange}
//                       placeholder="Enter 10-digit phone number"
//                       maxLength="10"
//                       required
...
const InstituteSetup = () => {
  ...
  const handleEditBranch = (branch) => {
    ...
    console.log("Extracted country code:", extractedCountryCode, "Number:", numberWithoutCode); // Debug log
