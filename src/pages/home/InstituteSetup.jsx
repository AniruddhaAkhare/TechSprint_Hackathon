...
//       contactNumber: branch.contactNumber || "", // New field
//       email: branch.email || "", // New field
//     });
//     setShowModal(true);
//   };
...
//         <span>Name</span>
//         <span>Address</span>
//         <span>Contact Number</span> {/* New column */}
//         <span>Email</span> {/* New column */}
//         <span>Status</span>
//         <span>Actions</span>
//       </div>
//       {branches.map((branch) => (
...
//             {branch.addressLine1}, {branch.city}, {branch.state}, {branch.postalCode}
//           </span>
//           <span>{branch.contactNumber || "Not set"}</span> {/* New column */}
//           <span>{branch.email || "Not set"}</span> {/* New column */}
//           <span className="status">
//             <span className={`status-dot ${branch.isActive ? "active" : "inactive"}`}></span>
//             {branch.isActive ? "Active" : "Inactive"}
//           </span>
...
//           </div>
//         </div>
//         {/* New Fields: Contact Number and Email */}
//         <div className="form-row">
//           <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <div className="phone-input-wrapper">
                    ...
                    <input
                      type="tel"
                      name="contactNumber"
                      value={branchForm.contactNumber.replace("+91", "")}
                      onChange={(e) => {
                        const value = e.target.value;
                        if (value.length <= 10) {
                          setBranchForm((prev) => ({ ...prev, contactNumber: `+91${value}` }));
                        }
                      }}
                      onKeyPress={handleNumericInput}
