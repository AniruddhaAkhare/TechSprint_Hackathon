                                ...
                                {(searchResults.length > 0 ? searchResults : students).map(student => (
                                    <tr key={student.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                            <button onClick={() => onDelete(student.id)} className="btn btn-primary bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Delete</button>
