...
// // // //         // For each student, get their installments subcollection
...
// // // //                 <td className="px-4 py-2 text-center">
// // // //                             {installment.dueDate && installment.dueDate instanceof Timestamp
// // // //                                 ? new Date(installment.dueDate.toDate()).toLocaleDateString()
// // // //                                 : installment.dueDate // Display the value as is if not a Timestamp
// // // //                             }
// // // //                         </td>
...
// // //       let dueDate;
// // //       if (installment.dueDate instanceof Timestamp) {
...
// //     const filteredInstallments = filterInstallments();
// //     const totalAmount = filteredInstallments.reduce((acc, installment) => acc + installment.dueAmount, 0);
...
// //                     <tbody>
// //                         {filteredInstallments.map((installment) => {
// //                             const dueDate = installment.dueDate instanceof Timestamp ? installment.dueDate.toDate() : new Date(installment.dueDate);
...
// //                                     <td className="px-4 py-2 text-center">₹{installment.dueAmount}</td>
// //                                     <td className="px-4 py-2 text-center">{installment.paid ? "Paid" : "Pending"}</td>
// //                                 </tr>
// //                             );
// //                         })}
...
//     const filteredInstallments = filterInstallments();
//     const totalAmount = filteredInstallments.reduce((acc, installment) => acc + Number(installment.dueAmount), 0); // Convert dueAmount to a number
...
export default function InstallmentReport() {
    ...
    //         // ... your fetch logic
    //         setInstallments(allInstallments);
    //         console.log(allInstallments); // Check fetched data
    //         setLoading(false);
    //     };
    ...
    const filterInstallments = () => {
        ...
        switch (filter) {
            ...
            //     startDate = new Date(0);
            //     endDate = new Date();
            //     console.log("all: startDate =", startDate, "endDate =", endDate);
            //     break;
            default:
